...
@section('contant')
    <div class="main-side">
        ...
        <form action="{{ route('dashboard.lessons.update', $item->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row g-4">
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    ...
                    <select name="status" id="" class="form-select select-setting">
                        @foreach (\App\enums\StatusLesson::cases() as $status)
