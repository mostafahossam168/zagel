@extends('dashboard.layouts.backend', ['title' => 'تعديل شريك'])
    ...
    <div class="main-side">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="main-title">
                ...
                <div class="large">تعديل شريك</div>
            </div>
        ...
        <form action="{{ route('dashboard.partners.update', $item->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row g-4">
