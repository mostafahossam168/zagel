@extends('dashboard.layouts.backend', ['title' => 'تعديل طالب'])
    ...
    <div class="main-side">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div class="main-title">
                ...
                <div class="small">الطلاب</div>/
                <div class="large"> تعديل طالب</div>
            </div>
            <div class="btn-holder">
                <a class="main-btn btn-main-color fs-13px" href="{{ route('dashboard.students.index') }}">رجوع <i
                        class="fa-solid fa-arrow-left fs-13px"></i>
                </a>
            </div>
        </div>
        <x-alert-component></x-alert-component>
        <form action="{{ route('dashboard.students.update', $item->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row g-4">
